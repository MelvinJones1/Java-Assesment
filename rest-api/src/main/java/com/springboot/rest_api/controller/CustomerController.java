...
public class CustomerController {
	...
	@Autowired
	private CustomerService customerService; // this is a dependency injection
	@Autowired
	...
	public List<Customer> getAllEmployees(@RequestParam int page, @RequestParam int size){
	...
	public ResponseEntity<?> hardDeleteCustomer(@PathVariable int id){
			...
			try {
				Customer customer = customerService.getSingleCustomer(id);
				customerService.hardDeleteCustomer(customer);
				messageDto.setBody("Customer record has been deleted from DB!");
